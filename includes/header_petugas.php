...
<head>
    ...
    <title><?= h($page_title ?? 'Petugas') ?> | Meine Welt Kafe</title>
    ...
    <div class="row">
        <aside class="col-md-3 col-lg-2 p-0 sidebar">
            <div class="text-center mb-4">
                ...
                <small class="opacity-75">Panel Petugas</small>
            </div>
            ...
            <nav>
                ...
                <a href="<?= BASE_URL ?>/petugas/pengaduan.php"
                   class="sidebar-link <?= in_array($current,['pengaduan.php','pengaduan_detail.php'])?'active':'' ?>">
                    <i class="bi bi-inbox-fill"></i> Daftar Pengaduan
                </a>
        ...
        <main class="col-md-9 col-lg-10 py-4 px-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h4 class="mb-0"><?= h($page_title ?? 'Petugas') ?></h4>
                    <small class="text-muted"><?= date('l, d F Y') ?></small>
                </div>
                <div class="dropdown">
                    <button class="btn btn-light dropdown-toggle" data-bs-toggle="dropdown">
                        <i class="bi bi-person-circle"></i> <?= h($user['full_name']) ?>
                        <span class="badge bg-primary ms-1">Petugas</span>
                    </button>
